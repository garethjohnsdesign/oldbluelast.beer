...
return [
      ...
      'imagerUrl' => 'http://storage.googleapis.com/old-blue-last-beer/',
      ...
      'imgixConfig' => [
          'default' => [
              'domains' => ['oldbluelastbeer.imgix.net'],
              'useHttps' => true,
              'signKey' => '',
              ...
              'defaultParams' => ['auto'=>'compress,format', 'q'=>50, 'fp-debug'=>false, 'exp'=>-2, 'blur'=>0, 'ch'=>'dpr', 'cs'=>'tinysrgb'],
              'apiKey' => '',
